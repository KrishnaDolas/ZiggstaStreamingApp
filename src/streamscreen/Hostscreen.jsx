...
const Hostscreen = ({ localStream, remoteStream, isStreaming, isViewerStreaming, isFrontCamera, isHost, switchCamera, toggleMute, leaveRoom, isMuted }) => {
      ...
      {isHost && (
        <View style={styles.streamBox}>
          <View style={{ flexDirection: 'row', height: '100%' }}>
            ...
            {isViewerStreaming && remoteStream && (
              <RTCView
              ...
              <View style={styles.strRoomHeader}>
                <View style={styles.strRoomHeaderLeft}>
                  ...
                  <View style={styles.strRoomHeaderLeftProfileInfo}>
                    <Text style={[styles.strRoomHeaderLeftProfileName]}>Angenlico Marias</Text>
                ...
                <View style={styles.strRoomHeaderRight}>
                  <View style={styles.strRoomHeaderRWalletInfo}>
                    <Ionicons name="diamond" size={14} color="#ffea23" />
