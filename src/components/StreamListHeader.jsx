        ...
        <View style={[styles.streamListHeader, themeStyles[theme].streamListHeader]} >
            ...
            {route.name === 'Main' && (
                <View style={styles.streamListHeaderBottom}>
                    ...
                    >
                        <TouchableOpacity onPress={() => setHeaderMainTab('foryou')} style={[styles.strHeaderCategoryButton, themeStyles[theme].strHeaderCategoryButton, headerMainTab === 'foryou' &&
                        ...
                        <TouchableOpacity onPress={() => {
                            ...
                            setHeaderMainTab('foryou')
                        }} style={[styles.strHeaderCategoryButton, themeStyles[theme].strHeaderCategoryButton, isNearBy &&
                            styles.btnInterestActive]}>
